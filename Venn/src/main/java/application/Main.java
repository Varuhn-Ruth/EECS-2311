...
//	GraphicsDevice gdev;
	...
	public void start(Stage primaryStage) {
		...
		//
				...
				vbox5.getChildren().addAll(cc1, cc2, cc3);
...
//				new line
				...
				text.setLayoutY(450);
				text.setPrefSize(150,  20);
				
				Button delete = new Button("Delete TexField");
				delete.setLayoutX(1100);
				delete.setLayoutY(490);
				delete.setPrefSize(150,  20);
				
				text.setOnAction(e -> {
					TextField insert = new TextField();					
					insert.setPrefSize(170, 50);
					insert.setLayoutX(1060);
				...
				cc1.setLayoutX(scn.getWidth()-160);
				cc1.setLayoutY(scn.getHeight()-scn.getHeight()+20);
			    ...
			    root.getChildren().addAll(capture1, display, txt, text, delete);
