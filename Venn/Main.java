...
public class Main extends Application {
	...
	Circle cirs2 =  new Circle (600,300,150, Color.rgb(255, 255, 255, 0.5));
	Circle cirb1 =  new Circle (360,300,250, Color.rgb(255, 255, 255, 0.5));
...
//				new line
				...
				root3.getChildren().add(sz2);
				    ...
				    button1.setOnAction(e -> {
				    	...
				    	String r3 = String.valueOf(textfield3.getText());
				    	Label4.setText(r3);
				    	});
